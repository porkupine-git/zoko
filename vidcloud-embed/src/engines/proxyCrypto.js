...
export const SCRAPER_NOTICE_TEXT = "VidCloud Edge Relay for vidcloud.sbs. Automated unauthorized scraping is restricted.";
export const SCRAPER_NOTICE_HEADER = "VidCloud Edge Relay. Direct stream scraping is protected.";
